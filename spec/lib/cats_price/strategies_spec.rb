...
describe CatsPrice::Strategies do
  it 'should return nil if strategy not found' do
    expect{described_class.strategy("Something")}.to raise_exception(KeyError)
  end

  it 'should accept symbol and return strategy class in case it exist' do
    expect(described_class.strategy(:json)).to eq(CatsPrice::Strategies::Json)
  end

  it 'should accept string and return strategy class in case it exist' do
